...
public class GlobalDisplayConstants {
    ...
    public void CalcConstants(int sizex, int sizey){
        ...
        for(int i = 0; i < 4; i++){
            ...
            labelBound.setTopBound(shipsInBank.get(i).getTopBound() + (shipsInBank.get(i).getBottomBound() - shipsInBank.get(i).getTopBound() - 20) / 2);
            ...
            labelBoundRotated.setLeftBound(shipsInBankRotated.get(i).getLeftBound() + 
                    (shipsInBankRotated.get(i).getRightBound() - shipsInBankRotated.get(i).getLeftBound() - 10) / 2);
        }
    }
}
